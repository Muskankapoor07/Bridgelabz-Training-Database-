...
BEGIN
    ...
    IF (TG_OP='DELETE') THEN
        ...
        (greeting_id,action_type,old_message,new_message,changed_by)
        VALUES
        (OLD.id,'DELETE',OLD.message,NULL,COALESCE(v_user,'UNKNOWN'));
    ...
    ELSIF (TG_OP='UPDATE') THEN
        ...
        (greeting_id,action_type,old_message,new_message,changed_by)
        VALUES
        (NEW.id,'UPDATE',OLD.message,NEW.message,COALESCE(v_user,'UNKNOWN'));
    ...
    ELSIF (TG_OP='INSERT') THEN
        ...
        (greeting_id,action_type,old_message,new_message,changed_by)
        VALUES
        (NEW.id,'INSERT',NULL,NEW.message,COALESCE(v_user,'UNKNOWN'));
...
(
'user_rohan',
'a06410c9379162de7a375181fe7dc9bcae66000cf8436ca7a9ea7149408cccb6',
'rohan@example.com',
'USER'
);
